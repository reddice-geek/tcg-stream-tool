    ...
    (async()=>{
      ...
      try{
        ...
        if(!localStorage.getItem('tcg_lang')){
          try{
            const installed =
              await invoke('get_install_language');
        ...
        setBootStatus(
          'Vérification de la base Yu-Gi-Oh!…'
        );

        setBootProgress(38);

        const ygo =
          await invoke('api_status',{
            game:'ygo',
            apiUrl:null,
            apiKey:null
          }).catch(e=>({
        ...
        setBootStatus(
          'Vérification de la base Pokémon TCG…'
        );
        ...
        addBootCheck(
          ...
          (
            pokemon.count != null
              ? `${pokemon.count} cartes`
              : ''
          )
        );

        setBootStatus(
          'Vérification de l’API One Piece…'
        );
      ...
      <div className="boot-screen">
        ...
        <div className="boot-card">
          ...
          <small className="boot-note">
            Vérification des services avant l’ouverture de TCG STREAM TOOL.
          </small>
